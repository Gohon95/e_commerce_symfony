 ...
 */
final class Version20200424105024 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contenu_panier_panier (contenu_panier_id INT NOT NULL, panier_id INT NOT NULL, INDEX IDX_7314121561405BF (contenu_panier_id), INDEX IDX_73141215F77D927C (panier_id), PRIMARY KEY(contenu_panier_id, panier_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
